...
describe("Subscriber Usage Activity", function(){  
    const userInfo = {
        "grant_type":"password",
        "username":"mapp004",
        "password":"test123",
   ...
   describe("Step 1", function(){
	...
	describe("Step 2", function(){
		it("Makes request to subscriberUsage", function(done){  
            request
                .get(`http://127.0.0.1:3000/apigateway?cid=${userInfo.cid}&mdn=${userInfo.mdn}`)
                .type('json')
                .set('service', 'subscriberUsage')
                .set('Content-Type', 'application/json')
